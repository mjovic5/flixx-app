const global = {
    ...
    api: {
        apiKey: '4e0bbe823ca802ff06d77b6014ad9df2',
...
async function fetchAPIData(endpoint) {
    ...
    const response = 
        await fetch(`${API_URL}${endpoint}?api_key=${API_KEY}&language=en-US`);
...
async function searchAPIData() {
    ...
    const response = 
        await fetch(`${API_URL}search/${global.search.type}?api_key=${API_KEY}&language=en-US&query=$${global.search.term}&page=${global.search.page}`);
